...
* #oura/daily_cardiovascular_age "Oura: daily_cardiovascular_age" "The Oura daily_cardiovascular_age source type. Grove converts it to oura-cardiovascular-age."
* #oura/daily_readiness "Oura: daily_readiness" "The Oura daily_readiness source type. Grove converts it to oura-readiness-score."
...
* #withings/getmeas:130 "Withings: getmeas:130" "The Withings getmeas:130 source type. Grove converts it to withings-atrial-fibrillation-notification-ecg."
* #withings/getmeas:135 "Withings: getmeas:135" "The Withings getmeas:135 source type. Grove converts it to qrs-duration."
* #withings/getmeas:136 "Withings: getmeas:136" "The Withings getmeas:136 source type. Grove converts it to pr-interval."
* #withings/getmeas:137 "Withings: getmeas:137" "The Withings getmeas:137 source type. Grove converts it to qt-interval."
* #withings/getmeas:138 "Withings: getmeas:138" "The Withings getmeas:138 source type. Grove converts it to corrected-qt-interval."
* #withings/getmeas:139 "Withings: getmeas:139" "The Withings getmeas:139 source type. Grove converts it to withings-atrial-fibrillation-notification-ppg."
* #withings/getmeas:155 "Withings: getmeas:155" "The Withings getmeas:155 source type. Grove converts it to withings-vascular-age."
* #withings/getmeas:167 "Withings: getmeas:167" "The Withings getmeas:167 source type. Grove converts it to withings-nerve-health-score."
...
* #withings/getmeas:170 "Withings: getmeas:170" "The Withings getmeas:170 source type. Grove converts it to withings-visceral-fat-index."
