...
* item[0].text = "Measure your weight now."
...
* item[1].text = "Measure your blood pressure now."
* item[1].type = #group
...
* item[1].item[0].text = "Systolic blood pressure"
...
* item[1].item[1].text = "Diastolic blood pressure"
