...
* #fhir-collection-bundle "FHIR R4 Collection Bundle" "One complete FHIR R4 Bundle in JSON representation with Bundle.type = collection, a mandatory timestamp, and one entry per source sample in source order. Every entry has a fullUrl and resource; request, response, and search are absent."
