...
Every Oura Ring element this adapter admits that no other source reports.
...
Such a value directly claims an Oura-scoped semantic profile rather than a shared one, together with the Oura Observation provider-lineage envelope.
