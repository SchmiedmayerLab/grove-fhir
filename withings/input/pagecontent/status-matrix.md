...
This table enumerates every Withings Health Mate field in the closed v0.6.0 source catalog. Each field has one definitive status. This guide profiles data already obtained by its caller; it contains no authentication, network, pagination, or fetching implementation.
