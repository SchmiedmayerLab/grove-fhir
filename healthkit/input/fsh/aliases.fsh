...
Alias: $healthKitECGClassification = https://grovealliance.org/fhir/healthkit/CodeSystem/healthkit-ecg-classification
Alias: $healthKitECGSymptomsStatus = https://grovealliance.org/fhir/healthkit/CodeSystem/healthkit-ecg-symptoms-status
Alias: $healthKitSymptomSeverity = https://grovealliance.org/fhir/healthkit/CodeSystem/healthkit-symptom-severity
Alias: $healthKitECGAlgorithmVersion = https://grovealliance.org/fhir/healthkit/CodeSystem/healthkit-ecg-algorithm-version
Alias: $healthKitMedicationDoseLogStatus = https://grovealliance.org/fhir/healthkit/CodeSystem/healthkit-medication-dose-log-status
Alias: $healthKitMedicationScheduleType = https://grovealliance.org/fhir/healthkit/CodeSystem/healthkit-medication-schedule-type
