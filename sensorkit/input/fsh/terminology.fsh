...
* #typing-speed "Typing speed" "Typing rate over the summarised interval. SensorKit's words-per-minute value is normalized to the profile's UCUM /s quantity."
...
* #batch-count "Batch count" "How many distinct (device, identifier) CoreMotion batch keys the summarised recording contains."
