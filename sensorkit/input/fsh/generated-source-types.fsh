...
* #acoustic-settings "Acoustic settings" "The SensorKit SRSensor.acousticSettings source type. Grove admits no output for it. Version 0.6.0 publishes no reviewed output contract for this stable platform symbol."
...
* #ambient-light "Ambient light" "The SensorKit SRSensor.ambientLightSensor source type. Grove admits no output for it. The source contains heterogeneous light fields for which version 0.6.0 does not publish a lossless component profile."
...
* #face-metrics "Face metrics" "The SensorKit SRSensor.faceMetrics source type. Grove admits no output for it. Version 0.6.0 publishes no reviewed structured profile for the heterogeneous face metrics."
...
* #media-events "Media events" "The SensorKit SRSensor.mediaEvents source type. Grove admits no output for it. Media interactions do not have a reviewed source-neutral clinical Observation representation in version 0.6.0."
...
* #siri-speech-metrics "Siri speech metrics" "The SensorKit SRSensor.siriSpeechMetrics source type. Grove admits no output for it. Speech metrics have no reviewed source-neutral clinical Observation representation in version 0.6.0."
...
* #telephony-speech-metrics "Telephony speech metrics" "The SensorKit SRSensor.telephonySpeechMetrics source type. Grove admits no output for it. Speech metrics have no reviewed source-neutral clinical Observation representation in version 0.6.0."
