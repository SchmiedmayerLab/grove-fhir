...
* #acoustic-settings "Acoustic settings" "The SensorKit SRSensor.acousticSettings source type. Grove admits no output for it. The Grove FHIR contracts publish no reviewed output contract for this stable platform symbol."
...
* #ambient-light "Ambient light" "The SensorKit SRSensor.ambientLightSensor source type. Grove admits no output for it. The source contains heterogeneous light fields for which the Grove FHIR contracts do not publish a lossless component profile."
...
* #face-metrics "Face metrics" "The SensorKit SRSensor.faceMetrics source type. Grove admits no output for it. The Grove FHIR contracts publish no reviewed structured profile for the heterogeneous face metrics."
...
* #media-events "Media events" "The SensorKit SRSensor.mediaEvents source type. Grove admits no output for it. Media interactions do not have a reviewed source-neutral clinical Observation representation under the Grove FHIR contracts."
...
* #siri-speech-metrics "Siri speech metrics" "The SensorKit SRSensor.siriSpeechMetrics source type. Grove admits no output for it. Speech metrics have no reviewed source-neutral clinical Observation representation under the Grove FHIR contracts."
...
* #telephony-speech-metrics "Telephony speech metrics" "The SensorKit SRSensor.telephonySpeechMetrics source type. Grove admits no output for it. Speech metrics have no reviewed source-neutral clinical Observation representation under the Grove FHIR contracts."
